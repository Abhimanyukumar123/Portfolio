...
const textLoad = () => {
    // setTimeout(() => {
    //     text.textContent = "Pursuing B.Tech";
    // }, 0);
    setTimeout(() => {
...
downloadBtn.addEventListener("click", () => {
    let resumePath =
        "https://docs.google.com/document/d/1G7hmyDVaZKQ04SLrXO71rxzcjmKLLV7dDudL4mTooHE/edit?tab=t.0"
...
function sendEmail() {
    ...
    Email.send({
        ...
        Username: "abhimanyukumar841424cpr@gmail.com",
        Password: "6D301B4566966758614CC5F4FF75DD761C2C",
        To: "abhimanyukumar841424cpr@gmail.com",
        From: "abhimanyukumar841424cpr@gmail.com",
        Subject: sub.value,
        Body: bodyMesg,
    }).then((message) =>
...
// Combine greeting and day
const greeting = getGreeting();
const day = getDayName();
document.getElementById('greeting').innerText = `${greeting} ${day}`;